...
extern cvar_t r_interpolate_anim; // fenix@io.com: model interpolation
extern cvar_t r_interpolate_pos;
...
#define FONT_W 12
#define FONT_H 24
#define TEXT_WIDTH ((640 - LEFT_MARGIN - RIGHT_MARGIN) / FONT_W)
#define TEXT_HEIGHT ((480 - 240 - TOP_MARGIN - BOTTOM_MARGIN) / FONT_H)
